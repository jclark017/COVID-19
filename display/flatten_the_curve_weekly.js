...
var countries = [
    {"name":"US", "color" : "steelblue", "lockdown":"2020-03-23"},
    {"name":"France", "color" : "red", "lockdown":"2020-03-23"},
    {"name":"Spain", "color" : "purple", "lockdown":"2020-03-16"},
...
var chartTypes = [
    ...
    {"name" :"ConfirmedDailyIncrease" , "location": {"left": 20, "top": 380, "position":"absolute"}, "ybasis":"zero", "title":"New Confirmed Cases by Week"},
    {"name" :"ConfirmedSDSMA4" , "location": {"left": 20, "top": 700, "position":"absolute"}, "ybasis":"function", "title":"Weekly New Case Growth"},
    {"name" :"Deaths" , "location": {"left": 650, "top": 60, "position":"absolute"}, "ybasis":"zero", "title":"Deaths"},
    {"name" :"DeathsDailyIncrease" , "location": {"left": 650, "top": 380, "position":"absolute"}, "ybasis":"zero", "title":"New Deaths by Week"},
    {"name" :"DeathsSDSMA4" , "location": {"left": 650, "top": 700, "position":"absolute"}, "ybasis":"function", "title":"Weekly New Death Growth"}
]
...
function LineChart () {
    d3.csv('../sql/SumByCountryWeekAnalysis.csv', function (error, dataProto) {
